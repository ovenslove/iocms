			...
			<div class="tc-box">
	        	...
	        	<div class="comment-ranking">
	        		...
	        		<?php if(is_array($last_comments)): foreach($last_comments as $key=>$vo): ?><div class="comment-ranking-inner">
	                        ...
	                        <a href="/iocms/<?php echo ($vo["url"]); ?>#comment<?php echo ($vo["id"]); ?>">查看原文</a>
			        	...
			        	<dl class="dl-horizontal">
				            <dt>
					            <a class="img-wraper" href="<?php echo U('article/index',array('id'=>$vo['tid']));?>">
					            	<?php if(empty($smeta['thumb'])): ?><img src="/iocms/tpl/simplebootx/Public/images/default_tupian4.png" class="img-responsive" alt="<?php echo ($vo["post_title"]); ?>"/>
									<?php else: ?> 
