      ...
      <table class="table table-bordered">
            ...
            <tr>
              ...
              <script type="text/plain" id="content" name="post[post_content]"></script>
                ...
                <script type="text/javascript"  src="/iocms/statics/js/ueditor/ueditor.config.js"></script>
                <script type="text/javascript"  src="/iocms/statics/js/ueditor/ueditor.all.min.js"></script>
				</td>
            </tr>
