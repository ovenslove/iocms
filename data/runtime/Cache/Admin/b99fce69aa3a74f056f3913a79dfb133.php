...
<![endif]-->
<link rel="stylesheet" href="/iocms/statics/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/simplebootadminindex.min.css?">
<!--[if lte IE 8]>
	<link rel="stylesheet" href="/iocms/statics/simpleboot/css/simplebootadminindex-ie.css?" />
<![endif]-->
<style>
...
<body style="min-width:900px;" screen_capture_injected="true">
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				<a href="/iocms/index.php?g=admin&m=index&a=index" class="brand"> <small>
						IOCODE 后台管理系统
				</small>
				</a>
				<div class="pull-left nav_shortcuts" >
					
					<a class="btn btn-small btn-warning" href="/iocms/" title="前台首页" target="_blank">
				...
				<ul class="nav simplewind-nav pull-right">
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							<!--<img class="nav-user-photo" src="/iocms/statics/images/icon/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>">管理员头像-->
	...
	<script src="/iocms/tpl_admin/simpleboot/assets/js/index.js"></script>
